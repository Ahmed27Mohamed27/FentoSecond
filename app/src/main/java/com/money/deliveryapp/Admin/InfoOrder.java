...
import com.money.deliveryapp.AdapterData;
import com.money.deliveryapp.MainActivity;
import com.money.deliveryapp.ModelDataOrders;
...
public class InfoOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deviceID = getIntent().getExtras().getString("uid");
    ...
    private void show_data() {
        ...
        reference.child("Orders").addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(InfoOrder.this, "Unable to fetch data" + error.getMessage(), Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    ...
    private void cancel_hagz(String name, String phone, String address, String kind) {
        ...
        cancel_hagz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(InfoOrder.this, "تم الغاء الحجز بنجاح", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(InfoOrder.this, MainActivity.class));
                finish();
            }
        });
